...
public class ImageWriterExample1 {
     ...
     *            a page number
     */
    protected void paintSome(final Graphics2D g2d, final int pageNum) {
        ...
        // Try attributed text
        final AttributedString aString = new AttributedString(
                "This is attributed text.");
    ...
    public static void main(final String[] args) {
        try {
            ...
            final File outputFile = new File(targetDir, "eps-example1.tif");
            final ImageWriterExample1 app = new ImageWriterExample1();
