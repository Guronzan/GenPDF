...
public interface Localizable {
    ...
    /**
     * Creates and returns a localized message, given the key of the message in
     * the resource bundle and the message parameters. The messages in the
     * resource bundle must have the syntax described in the
     ...
     */
    String formatMessage(final String key, final Object[] args)
