...
/**
 * Immutable class representing a penalty value. It's valid value range is that
 * of an {@link Integer}, but giving {@link Integer#MAX_VALUE} a special
 * meaning: it means infinite penalty, i.e. a candidate with this penalty will
 * be excluded from any choice.
 */
public final class Penalty {

    public static final Penalty ZERO_PENALTY = new Penalty(0);
    public static final Penalty INFINITE_PENALTY = new Penalty(
            Integer.MAX_VALUE);
    ...
    private Penalty(final int value) {
        this.value = value;
    }
    ...
    public Penalty add(final int value) {
        final long p = (long) getValue() + value;
    ...
    /**
     * Indicates whether this is an infinite penalty, meaning that a solution
     * with this penalty is effectively ineligible.
     * 
    ...
    public String toString() {
        return "Penalty: "
                + (isInfinitePenalty() ? "INF" : Integer.toString(getValue()));
    }
