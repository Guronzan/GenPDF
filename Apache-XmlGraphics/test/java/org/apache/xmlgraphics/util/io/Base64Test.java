...
public class Base64Test extends TestCase {
    ...
    private void innerBase64Test(final String action, final String in,
            final String ref) throws Exception {
    ...
    private void innerBase64Test(final String in) throws Exception {
        innerBase64Test("ROUND", in, in);
    }

    private void testBase64Group(final String name) throws Exception {
