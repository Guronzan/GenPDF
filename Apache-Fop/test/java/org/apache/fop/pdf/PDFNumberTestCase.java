...
public class PDFNumberTestCase extends PDFObjectTestCase {
    ...
    @Before
    public void setUp() {
        this.pdfObjectUnderTest = new PDFNumber();
    ...
    public void testDoubleOut4() throws Exception {
        final double d = Double.parseDouble("5.7220458984375E-6");
     ...
     * Why there isn't a constructor is beyond me...
     */
    public void testGetSetNumber() {
        final PDFNumber pdfNum = new PDFNumber();
    ...
    public void testToPDFString() throws IOException {
        final PDFNumber testSubject = new PDFNumber();
