...
/* $Id: CommonAccessibilityHolderTestCase.java 1242848 2012-02-10 16:51:08Z phancock $ */
...
/**
 * This tests that all the FONodes that implement CommonAccessibilityHolder
 * correctly configure the CommonAccessibility property.
 */
public class CommonAccessibilityHolderTestCase {

    private static final List<Class<? extends CommonAccessibilityHolder>> IMPLEMENTATIONS = new ArrayList<Class<? extends CommonAccessibilityHolder>>();
    ...
    static {
        /*
         * This triggers 'unimplemented feature' FO validation events so that
         * the event system is not triggered when testing, avoiding extra
         * convoluted dependency stubbing.
         */
        ...
        IMPLEMENTATIONS
                .add(org.apache.fop.fo.pagination.bookmarks.Bookmark.class);
        IMPLEMENTATIONS
                .add(org.apache.fop.fo.pagination.bookmarks.BookmarkTitle.class);
        ...
        IMPLEMENTATIONS
                .add(org.apache.fop.fo.flow.PageNumberCitationLast.class);
    ...
    /**
     * Bind should be overridden to correctly configure the CommonAccessibility
     * property
     * 
     * @throws Exception
     *             -
    ...
    public void bindMustSetRoleAndSourceDoc() throws Exception {
        ...
        for (final Class<? extends CommonAccessibilityHolder> clazz : IMPLEMENTATIONS) {
            final Constructor<? extends CommonAccessibilityHolder> constructor = clazz
                    .getConstructor(FONode.class);
            final CommonAccessibilityHolder sut = constructor
                    .newInstance(parent);
            ((FONode) sut).bind(mockPList);
            final String errorMessage = "Test failed for " + clazz + ": ";
            assertEquals(errorMessage, this.role, sut.getCommonAccessibility()
                    .getRole());
            assertEquals(errorMessage, this.sourceDocument, sut
                    .getCommonAccessibility().getSourceDocument());
        }
    }
    ...
    private void mockRoleProperty(final PropertyList mockPList)
    ...
    private void mockSourceDocProperty(final PropertyList mockPList)
            throws PropertyException {
        ...
        when(mockPList.get(Constants.PR_SOURCE_DOCUMENT)).thenReturn(
                mockSourceDocProperty);
    }
