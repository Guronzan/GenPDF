...
public final class BidiTestData {
    ...
    public static int[] readTestData(final String prefix, final int index) {
        int[] data = null;
        InputStream is = null;
        final Class btc = BidiTestData.class;
        final String name = btc.getSimpleName() + "$" + prefix + index + ".ser";
        try {
