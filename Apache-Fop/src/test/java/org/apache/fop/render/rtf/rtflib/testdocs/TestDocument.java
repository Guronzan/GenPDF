...
abstract class TestDocument {
    ...
    final void generateOutput() throws IOException {
        debugMsg("Generating document " + this.output + "...");
        final RtfFile f = new RtfFile(new FileWriter(this.output));
    ...
    protected abstract void generateDocument(final RtfDocumentArea rda,
            final RtfSection sect) throws IOException;

    void debugMsg(final String msg) {
        System.err.println(msg);
    }

    protected void addIntroComments(final RtfSection sect) throws IOException {
