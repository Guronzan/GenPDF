...
public abstract class AbstractGraphicsLayoutManager extends
    ...
    private InlineViewport getInlineArea() {
        ...
        final int bidiLevel = fobj.getBidiLevel();
        ...
        if (bidiLevel == -1 || (bidiLevel & 1) == 0) {
            ...
            int endIPD = borderProps.getPadding(
                    CommonBorderPaddingBackground.END, false, this);
            endIPD += borderProps.getBorderWidth(
                    CommonBorderPaddingBackground.END, false);
            placement.x += endIPD;
        }
        ...
        final InlineViewport vp = new InlineViewport(viewportArea, bidiLevel);
        ...
        TraitSetter.addBorders(vp, borderProps, false, false, false, false,
                this);
        TraitSetter.addPadding(vp, borderProps, false, false, false, false,
                this);
    ...
    public List getNextKnuthElements(final LayoutContext context,
            final int alignment) {
        final InlineViewport areaCurrent = getInlineArea();
