...
public interface IFPainter {
     ...
     *            and [X,Y] advancement adjustments, in that order (may be
     *            null); if not null, then adjustments.length must be the same
     *            as text.length()
     * @param text
     *            the text
     * @throws IFException
     ...
     *             if an error occurs while handling this event
     */
    void drawBorderRect(final Rectangle rect, final BorderProps top,
