...
public class BookmarkData extends AbstractOffDocumentItem implements Resolvable {
    ...
    private final List<BookmarkData> subData = new java.util.ArrayList<BookmarkData>();
    ...
    private final Map<String, List<Resolvable>> unresolvedIDRefs = new java.util.HashMap<String, List<Resolvable>>();
