...
public class CTM implements Serializable {
     ...
     */
    public static CTM getWMctm(final WritingMode wm, final int ipd,
            final int bpd) {
        CTM wmctm;
    ...
    public CTM multiply(final CTM premult) {
        return new CTM(premult.a * this.a + premult.b * this.c, premult.a
                * this.b + premult.b * this.d, premult.c * this.a + premult.d
                * this.c, premult.c * this.b + premult.d * this.d, premult.e
                * this.a + premult.f * this.c + this.e, premult.e * this.b
                + premult.f * this.d + this.f);
    }
    ...
    public static CTM getCTMandRelDims(final int absRefOrient,
            final WritingMode writingMode, final Rectangle2D absVPrect,
