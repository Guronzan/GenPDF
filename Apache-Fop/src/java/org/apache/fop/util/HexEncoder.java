...
public final class HexEncoder {
    ...
    /**
     * Returns an hex encoding of the given number as a string of the given
     * length, left-padded with zeros if necessary.
     *
     * @param n
     *            a number
     * @param width
     ...
     */
    public static String encode(int n, final int width) {
        final char[] digits = new char[width];
    ...
    /**
     * Returns an hex encoding of the given character as a four-character
     * string.
     *
     * @param c
     *            a character
