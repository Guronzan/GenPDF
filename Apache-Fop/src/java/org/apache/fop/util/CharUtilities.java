...
public class CharUtilities {
     ...
     */
    public static int classOf(final int c) {
        switch (c) {
        case CODE_EOT:
            return EOT;
        case LINEFEED_CHAR:
     ...
     */
    public static boolean isNonBreakableSpace(final int c) {
     ...
     */
    public static boolean isAnySpace(final int c) {
     ...
     * reference. If in the BMP, four digits are used, otherwise 6 digits are
     * used.
     * 
     * @param c
    ...
    /**
     * Convert a string to a sequence of ASCII or XML numeric character
     * references.
     * 
     * @param s
     *            a java string (encoded in UTF-16)
     * @return a string representing a sequence of numeric character reference
     *         or ASCII characters
     */
    public static String toNCRefs(final String s) {
        final StringBuffer sb = new StringBuffer();
        if (s != null) {
     ...
     */
    public static String padLeft(final String s, final int width, final char pad) {
        final StringBuffer sb = new StringBuffer();
    ...
    /**
     * Format character for debugging output, which it is prefixed with "0x",
     * padded left with '0' and either 4 or 6 hex characters in width according
     * to whether it is in the BMP or not.
     * 
     * @param c
     *            character code
     * @return formatted character string
     */
    public static String format(final int c) {
        if (c < 1114112) {
            return "0x"
                    + padLeft(Integer.toString(c, 16), c < 65536 ? 4 : 6, '0');
        } else {
     ...
     * @return true if both sequences have same length and same character
     *         sequence
     */
    public static boolean isSameSequence(final CharSequence cs1,
