...
/**
 * This class represents a "Separation" color space. It is used in FOP to map
 * named colors.
 */
public class PDFSeparationColorSpace extends PDFArray implements PDFColorSpace {
     ...
     * @param tintFunction
     *            the tint function used as fallback
     */
    public PDFSeparationColorSpace(final String colorName,
            final PDFFunction tintFunction) {
        super();
    ...
    /**
     * Returns a reference to the tint function that is used as a fallback if
     * the colorant is not available.
     * 
