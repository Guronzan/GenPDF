...
public class PDFFontDescriptor extends PDFDictionary {
    ...
    public PDFFontDescriptor(
            ...
            final String basefont, final int ascent, final int descent,
            final int capHeight, final int flags, final PDFRectangle fontBBox,
            final int italicAngle, final int stemV) {
        super();
