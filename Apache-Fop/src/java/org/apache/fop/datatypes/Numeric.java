 ...
 * <p>
 * To support relative numerics internally in the expression parser and during
 * evaluation one additional methods exists: isAbsolute() which return true for
...
public interface Numeric {
     ...
     * of the expression tree and relative numerics can then return a resolved
     * absolute Numeric. Absolute numerics can just return themselves.
     *
