...
public class PDFDocument {
    ...
    private final List<Long> indirectObjectOffsets = new ArrayList<Long>();

    private Collection<PDFStructElem> structureTreeElements;

    /** List of objects to write in the trailer */
    private final List<PDFObject> trailerObjects = new ArrayList<PDFObject>();

    /** the objects themselves */
    private final List<PDFObject> objects = new LinkedList<PDFObject>();
    ...
    private final Map<String, PDFXObject> xObjectsMap = new HashMap<String, PDFXObject>();

    private final Map<String, PDFFont> fontMap = new HashMap<String, PDFFont>();

    private Map<String, List<String>> filterMap = new HashMap<String, List<String>>();

    private final List<PDFGState> gstates = new ArrayList<PDFGState>();

    private final List<PDFFunction> functions = new ArrayList<PDFFunction>();

    private final List<PDFShading> shadings = new ArrayList<PDFShading>();

    private final List<PDFPattern> patterns = new ArrayList<PDFPattern>();

    private final List<PDFLink> links = new ArrayList<PDFLink>();

    private List<PDFDestination> destinations;

    private final List<PDFFileSpec> filespecs = new ArrayList<PDFFileSpec>();

    private final List<PDFGoToRemote> gotoremotes = new ArrayList<PDFGoToRemote>();

    private final List<PDFGoTo> gotos = new ArrayList<PDFGoTo>();

    private final List<PDFLaunch> launches = new ArrayList<PDFLaunch>();
