...
public class LayoutMasterSet extends FObj {
    ...
    protected void startOfNode() throws FOPException {
        ...
        this.simplePageMasters = new java.util.HashMap<String, SimplePageMaster>();
        this.pageSequenceMasters = new java.util.HashMap<String, PageSequenceMaster>();
    }
    ...
    private void checkRegionNames() throws ValidationException {
        ...
        final Map<String, String> allRegions = new java.util.HashMap<String, String>();
