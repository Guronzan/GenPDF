...
public interface SubSequenceSpecifier {
     ...
     */
    SimplePageMaster getNextPageMaster(final boolean isOddPage,
    ...
    /**
     * called by the parent LayoutMasterSet to resolve object references from
     * simple page master reference names
     * 
     ...
     * */
    void resolveReferences(final LayoutMasterSet layoutMasterSet)
            throws ValidationException;
     ...
     *         entire main flow
     */
    boolean canProcess(final String flowName);
    ...
    /**
     * Test if this can be reused when it is the last sub-sequence specifer, and
     * has been exhausted
     * 
