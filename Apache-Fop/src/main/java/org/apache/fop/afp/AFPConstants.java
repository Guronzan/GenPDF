...
public interface AFPConstants {
     ...
     * of the default line width is implementation defined, which probably means
     * different devices use different actual widths; this means that the source
     * line width (as specified in, say, a SVG line element) needs to be
     * corrected by a fudge factor that depends on the output device so that the
     * final output (print to paper, screen viewer) looks as intended.
     */
