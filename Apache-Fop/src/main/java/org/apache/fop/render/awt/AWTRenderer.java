...
public class AWTRenderer extends Java2DRenderer implements Pageable {
     ...
     *
     * @param userAgent
     *            the user agent that contains configuration data
     */
    public AWTRenderer(final FOUserAgent userAgent) {
     ...
     *            the user agent that contains configuration data
     * @param renderable
     *            a Renderable instance can be set so the Preview Dialog can
     *            enable the "Reload" button which causes the current document
     *            to be reprocessed and redisplayed.
     * @param previewAsMainWindow
     *            true if the preview dialog created by the renderer should be
     *            the main window of the application.
     * @param show
     *            sets whether the preview dialog should be created and
     *            displayed when the rendering has finished.
     */
    public AWTRenderer(final FOUserAgent userAgent,
            final Renderable renderable, final boolean previewAsMainWindow,
            final boolean show) {
        super(userAgent);
        if (show) {
            ...
            setStatusListener(PreviewDialog.createPreviewDialog(userAgent,
                    renderable, previewAsMainWindow));
        }
    }
