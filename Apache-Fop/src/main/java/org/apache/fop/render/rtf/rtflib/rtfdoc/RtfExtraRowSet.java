 ...
 * <li>an RtfTableCell that contains a nested table can ask this to put some of
 * its children in extra rows that after the current row
 * <li>once RtfTableRow is done rendering its children, it renders this, causing
 * extra rows to be generated, with content that can come from several
 * RtfTableCells
 * </ul>
 *
 * <p>
