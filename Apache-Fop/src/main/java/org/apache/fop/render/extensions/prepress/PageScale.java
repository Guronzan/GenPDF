...
/**
 * This class provides utility methods to parse the 'fox:scale' extension
 * attribute.
 */
public final class PageScale {
     ...
     */
    public static final QName EXT_PAGE_SCALE = new QName(
            ExtensionElementMapping.URI, null, "scale");
    ...
    /**
     * Compute scale parameters from given fox:scale attribute which has the
     * format: scaleX [scaleY] If scaleY is not defined, it equals scaleX.
     * 
     * @param scale
     *            scale attribute, input format: scaleX [scaleY]
     * @return the pair of (sx, sy) values
     */
    public static Point2D getScale(final String scale) {
        ...
        final String[] scales = WHITESPACE_PATTERN.split(scale);
        double scaleX;
        try {
