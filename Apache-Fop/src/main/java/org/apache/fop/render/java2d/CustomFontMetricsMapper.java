 ...
 * {@link org.apache.fop.fonts.FontMetrics} instance. This class was designed to
 * allow the underlying {@link Font} to be loaded from a user-configured file
 * not registered in the current graphics environment.
 */
